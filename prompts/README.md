...
| --- | --- | --- |
| [Test](./customer-preparation/test-mthgbfn3.md) | test | Michael Sheerin |
...
| [Generate a Weekly Dedicated-Pool Capacity Report](./data-reporting/dedicated-pool-capacity-report.md) | Use this prompt to create a current weekly capacity report for a dedicated pool across selected regions and availability domains. It queries live Compute Admin inventory, validates Global-AD and Tenant-AD mappings from authoritative metadat | Michael Sheerin |
